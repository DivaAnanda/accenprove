  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-primary-50 to-white flex flex-col">
      ...
      <div className="flex-1 max-w-4xl w-full mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold text-primary-600 mb-8">Informasi Cara Pengajuan Berita Acara</h1>
        
        <div className="bg-white rounded-xl shadow-sm p-8">
          <h2 className="text-2xl font-bold text-primary-600 mb-6">Langkah-langkah Pengajuan Berita Acara</h2>
          ...
          <ol className="space-y-4 mb-8 text-gray-700">
            ...
            <li className="flex gap-4">
              <span className="flex-shrink-0 w-8 h-8 bg-primary-600 text-white rounded-full flex items-center justify-center font-bold">5</span>
              <span className="pt-1">Klik tombol <strong>Kirim Pengajuan</strong>.</span>
            </li>
            <li className="flex gap-4">
              <span className="flex-shrink-0 w-8 h-8 bg-primary-600 text-white rounded-full flex items-center justify-center font-bold">6</span>
